...
<div class="sidebar">
    ...
    <section class="homepage-hero-wrapper">
        <div class="homepage-hero-inner first-title-wrapper">
          <h1 class="homepage-first-title">We Are</h1>
        </div>
        <!-- / -->
        <div class="homepage-hero-inner second-title-wrapper">
            <h1 class="homepage-middle-title">
                <span>SEO</span>
                <span>agentur</span>
                <span>WIEN</span>
            </h1>
    ...
    <!-- END OF HERO SECTION
    ------------------------>
    <section class="homepage-showcase-wrapper">
        <div class="homepage-showcase-title-wrapper">
           <h1>Wanna get</h1>
           <h2>Boosted?</h2>
        </div>
        <!-- images -->
        <div class="homepage-showcase-image-wrapper">
            <div class="icon-wrapper"><img  src="./assets/images/Iconlar-01.png" alt=""></div>
            <!-- plus -->
            <div class="plus-wrapper"><img src="./assets/images/+.png" alt=""></div>
            <div class="icon-wrapper"><img src="./assets/images/Iconlar-02.png" alt=""></div>
            <!-- plus -->
            <div class="plus-wrapper"><img src="./assets/images/+.png" alt=""></div>
            <div class="icon-wrapper"><img src="./assets/images/Iconlar-03.png" alt=""></div>
            <!-- plus -->
            <div class="plus-wrapper"><img src="./assets/images/+.png" alt=""></div>
            <div class="icon-wrapper"><img src="./assets/images/Iconlar-04.png" alt=""></div>
            <!-- plus -->
            <div class="plus-wrapper"><img src="./assets/images/+.png" alt=""></div>
            <div class="icon-wrapper"><img src="./assets/images/Group 101.png" alt=""></div>
        </div>
...
<div class="section-spacer"></div>
<!-- DESIGN SECTION -->
<section class="homepage-design-wrapper">
    <div class="homepage-design-content-wrapper">
        <h2>MODERN</h2>
        <h2>App <br>
            Entwicklung</h2>
        <hr style="border: #87969A 1px solid; width: 140px">
        <p class="section-p">
            Sie haben eine App Idee? Wir setzen diese um! Unser Team bietet Ihnen eine professionelle Appentwicklung für alle Endgeräte an. Wir fokussieren uns darauf, das Risiko Ihrer Investition zu entfernen und Ihnen ein Produkt zu liefern, das Ihr Publikum anspricht. Unsere Programmierer testen jede Idee, die uns vorgestellt wird, um sicherzustellen, dass Ihre Idee den Marktveränderungen und Trends standhält. Nehmen Sie mit uns Kontakt für ein Beratungsgespräch auf. Eine APP Idee kann große Erfolge bringen.
        </p>
...
<section class="homepage-sec3-wrapper">
    ...
    <div class="homepage-sec3-content-wrapper">
       <h2>WEB DESIGN</h2>
       <h2>WIEN</h2>
      <h2>Ihre Onlinepräsenz ist das A und O</h2>
       <hr style="border: #87969A 1px solid; width: 140px">
    <p>
        Das perfekte Gleichgewicht von Kreativität und Simplizität – professionelle Webseiten mit dem SEO Solutions Team. Gewinnen Sie Neukunden und verbessern Sie Ihre Online Marketing Präsenz mit der Macht des modernen Webdesigns. Eine gute Internetseite beeinflusst direkt die Nutzererfahrung – und kann der entscheidende Faktor sein. Unsere Webdesign Agentur mit dem Sitz in Wien bietet Ihnen optimale Design Lösungen für Ihr Unternehmen an.
    </p>
...
<div class="section-spacer"></div>
    <!-- SECTION 4 -->
    <section class="homepage-sec4-wrapper">
        <div class="homepage-sec4-content-wrapper">
            <h2>LOGO</h2>
            <h2>DESIGN</h2>
            <h2>Unternehmensidentität</h2>
            <hr style="border: #87969A 1px solid; width: 140px">
            <p class="section-p">
                Steigern Sie Ihr Marketingimage mit einem modernen Logo für Ihr Unternehmen. Unser Ziel ist es mit unserer Nischenstrategie professionelle Branding Dienstleistungen anzubieten und die Zielgruppen Ihres Unternehmens direkt anzusprechen. Ein Logo ist Ihr persönliches Markenzeichen und sollte nicht nur gut aussehen, sondern auch die Botschaft Ihrer Firma unterstützen. Unsere Grafiker achten auf die richtige Farbauswahl und zeichnen jedes Logo individuell.
            </p>
...
<section class="contact-section-outer-wrapper">
    ...
    <div class="form-wrapper">
        <div>
            <h2>KONTAKT</h2>
            <h5>Online Marketing ist die Zukunft</h5>
        </div>
        <form>
            <input type="text" placeholder="Name">
            <input type="email" placeholder="E-Mail">
            <input type="tel" name="" placeholder="Telefonnumer">
    ...
    <div class="contact-details-wrapper">
        <div>
            <p>
               <img src="./assets/images/flag icon.png" alt="">
                <span>Pyrkergasse 30-32</span>
                <span>1190 Wien</span>

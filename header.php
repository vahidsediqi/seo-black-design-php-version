...
<head>
    ...
    <meta name="robots" content="noindex,nofollow">
        ...
        <link rel="stylesheet" href="./assets/styles/fonts.css?v=<?php echo time();?> " >  
        ...
        <link rel="stylesheet" href="./assets/styles/nav.css?v=<?php echo time(); ?>">
         <link rel="stylesheet" href="./assets/styles/responsive.css?v=<?php echo time();?> ">
        <link rel="stylesheet" href="http://fonts.cdnfonts.com/css/heaters">
      ...
      <header class="header">
        <nav class="navbar navbar-expand-lg fixed-top py-3">
            ...
            <a href="https://www.seosolutions.at/dark/" class="navbar-brand text-uppercase font-weight-bold">
